...
export class AppModule {
    ...
    constructor(public oidcSecurityService: OidcSecurityService) {
        ...
        if (environment.production) {
            openIDImplicitFlowConfiguration.stsServer = 'http://angular-oidc-php.infinityfreeapp.com';
            openIDImplicitFlowConfiguration.redirect_url = 'http://angular-oidc-php.infinityfreeapp.com';
            openIDImplicitFlowConfiguration.client_id = 'AngularClient';
            openIDImplicitFlowConfiguration.response_type = 'id_token token';
            openIDImplicitFlowConfiguration.scope = 'openid offline_access profile email groups resource';
            openIDImplicitFlowConfiguration.post_logout_redirect_uri = 'http://angular-oidc-php.infinityfreeapp.com';
            ...
            openIDImplicitFlowConfiguration.override_well_known_configuration_url =
                'http://angular-oidc-php.infinityfreeapp.com/server/.well-known/openid-configuration';
        } else {
